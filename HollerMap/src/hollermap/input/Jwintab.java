 ...
 * @author rekimoto Log: 1.29.2000 rekimoto: add pressure parameter 1.8.2000
 * rekimoto: initial creation
 *
 *
 */
public class Jwintab {
     ...
     */
    public static native int getPacket(float lesX[], float lesY[], int lesButton[], long lesTimes[]);
}
